...
export default function CallScreen({roomId, screens, setScreen}) {
  ...
  const drawImage = async () => {
    let base64Image = await captureScreen();
    const url = 'http://192.168.0.104:5000/predict';
  ...
  return (
    <View className="flex-1 ">
      <View style = {{height:300, width:300, marginLeft:50, borderWidth: 4, borderColor: 'red', borderRadius: 10}}>
        {!remoteStream && (
          <RTCView
            className="flex-1"
